import type { LocaleDefinition, MetadataDefinition } from '@faker-js/faker/definitions';
import type { LocaleProxy } from '@faker-js/faker/locale-proxy';
import { AirlineModule } from '@faker-js/faker/modules/airline';
import { AnimalModule } from '@faker-js/faker/modules/animal';
import { ColorModule } from '@faker-js/faker/modules/color';
import { CommerceModule } from '@faker-js/faker/modules/commerce';
import { CompanyModule } from '@faker-js/faker/modules/company';
import { DatabaseModule } from '@faker-js/faker/modules/database';
import { DateModule } from '@faker-js/faker/modules/date';
import { FinanceModule } from '@faker-js/faker/modules/finance';
import { GitModule } from '@faker-js/faker/modules/git';
import { HackerModule } from '@faker-js/faker/modules/hacker';
import { HelpersModule } from '@faker-js/faker/modules/helpers';
import { ImageModule } from '@faker-js/faker/modules/image';
import { InternetModule } from '@faker-js/faker/modules/internet';
import type { LocationModule as AddressModule } from '@faker-js/faker/modules/location';
import { LocationModule } from '@faker-js/faker/modules/location';
import { LoremModule } from '@faker-js/faker/modules/lorem';
import { MusicModule } from '@faker-js/faker/modules/music';
import type { PersonModule as NameModule } from '@faker-js/faker/modules/person';
import { PersonModule } from '@faker-js/faker/modules/person';
import { PhoneModule } from '@faker-js/faker/modules/phone';
import { RandomModule } from '@faker-js/faker/modules/random';
import { ScienceModule } from '@faker-js/faker/modules/science';
import { SystemModule } from '@faker-js/faker/modules/system';
import { VehicleModule } from '@faker-js/faker/modules/vehicle';
import { WordModule } from '@faker-js/faker/modules/word';
import type { Randomizer } from '@faker-js/faker/randomizer';
import { SimpleFaker } from '@faker-js/faker/simple-faker';
/**
